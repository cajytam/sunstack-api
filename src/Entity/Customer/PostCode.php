...
class PostCode
{
    ...
    public static function getDepartmentByNumber(int $departmentNumber): string
    {
        if (!array_key_exists($departmentNumber, self::DEPARTEMENTS)) {
            throw new \InvalidArgumentException(sprintf('Le département avec le numéro %d n\'existe pas', $departmentNumber));
        }

        return self::DEPARTEMENTS[$departmentNumber];
    }
