...
class CompanyTypeRepository extends ServiceEntityRepository
{
    ...
    public function findCompanyTypeByCategorieJuridique(string|int $categorieJuridique): array
    {
        $query = $this->createQueryBuilder('a')
            ->where('a.mapInseeCategoriesJuridiques LIKE :categorie')
            ->setParameter('categorie', '%' . $categorieJuridique . '%')->getQuery();
